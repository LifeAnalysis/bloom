...
//!
//! Lives here (rather than in beth-tx) because the prices crate pulls
//! reqwest+rustls and we don't want that on tx-engine consumers that
//! only care about staging.

use alloy::primitives::U256;
use async_trait::async_trait;
use beth_prices::{CoinId, PricesClient};
use beth_tx::oracle::PriceOracle;
...
/// resolve to ethereum's coingecko slug inside [`beth_prices`].
